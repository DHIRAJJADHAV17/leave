                ...
                <div class="col-12">
                    <div class="login_box">
                        ...
                        <form class="login_form" action="/adminlogin" method="post">
                            <input type="text" name="email" placeholder="email" class="login_formele" required>
                            <input type="password" name="password" placeholder="password" class="login_formele" required>
